<form id="form_validation" method="post" action="{{route('service-vaccination-center')}}" class="uk-form-stacked">
{!! csrf_field() !!}
<input type="hidden" name="subject" value="Vaccination Center" />
