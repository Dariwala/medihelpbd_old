<form id="form_validation" method="post" action="{{route('service-addiction-rehabilitation-center')}}" class="uk-form-stacked">
{!! csrf_field() !!}
  ...
  <p style="font-size: 16px;font-weight: bold; margin-bottom: 25px;">সাধারণ তথ্য  </p>
     ...
     <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                ...
                <textarea type="text" name="home_service_service_charge"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                ...
                <textarea type="text" name="medical_department_name"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="email">সেবা ঘণ্টা</label>
                <textarea type="text" name="pharmacy_service_hour"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="email">কার্য দিবস</label>
                <textarea type="text" name="pharmacy_working_day"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="email">বন্ধ</label>
                <textarea type="text" name="pharmacy_closed"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="email">যোগাযোগের নম্বর</label>
                <textarea type="text" name="pharmacy_contact_number"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
    <br>
    ...
    <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                ...
                <textarea type="text" name="home_delivery_minimum_order"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="email">সেবার পরিধি</label>
                <textarea type="text" name="home_delivery_service_area"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                ...
                <textarea type="text" name="home_delivery_charge"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                ...
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                   <label class="inline-label"><input type="radio" value="Yes" name="home_delivery_charge_negotiable"id="val_radio_male" data-md-icheck ><span style="padding:5px">হ্যাঁ</span></label> 
                </span>
                <br>
                <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                     <label class="inline-label"><input type="radio" value="No" id="val_radio_male" data-md-icheck name="home_delivery_charge_negotiable"> <span style="padding:5px">না</span></label> 
                 </span>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="email">সেবা ঘণ্টা</label>
                <textarea type="text" name="home_delivery_service_hour"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
        ...
        <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="email">কার্য দিবস</label>
                <textarea type="text" name="home_delivery_working_day"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
        ...
        <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="email">কার্য দিবস:</label>
                <textarea type="text" name="home_delivery_closed"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
         <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="email">যোগাযোগের নম্বর: </label>
                <textarea type="text" name="home_delivery_number"  class="md-input" rows="2" cols="10" ></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                ...
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                   <label class="inline-label"><input type="radio" value="Yes" name="home_delivery_charge_negotiable"id="val_radio_male" data-md-icheck ><span style="padding:5px">YES</span></label> 
                </span>
                <br>
                <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                     <label class="inline-label"><input type="radio" value="No" id="val_radio_male" data-md-icheck name="home_delivery_charge_negotiable"> <span style="padding:5px">NO</span></label> 
                 </span>
            </div>
        </div>
    </div>
