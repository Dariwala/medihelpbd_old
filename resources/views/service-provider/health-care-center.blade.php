...
@if(Session('language')=='bn')
    ...
    <label style="font-size: 16px;font-weight: bold; margin-top: 6px;">ডাক্তার </label><span>(যদি থাকে, ডক্টরস্‌ প্যানেলে বিস্তারিত লিখুন)</span>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="hotline">কার্য দিবস</label>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                <label for="emergency_number" class=""> এক্সিকিউটিভ বেসিক চেক আপ-পুরুষ/মহিলা   </label> 
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                   <label class="inline-label"><input type="radio" value="Yes" name="hlt_chk_exe_basic"id="val_radio_male" data-md-icheck ><span style="padding:5px">হ্যাঁ</span></label> 
                </span>
                <br>
                <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                     <label class="inline-label"><input type="radio" value="No" id="val_radio_male" data-md-icheck name="hlt_chk_exe_basic"> <span style="padding:5px">না</span></label> 
                 </span>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                <label for="emergency_number" class=""> এক্সিকিউটিভ প্রিমিয়ার চেক আপ-পুরুষ/মহিলা   </label> 
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                   <label class="inline-label"><input type="radio" value="Yes" name="hlt_chk_exe_premier"id="val_radio_male" data-md-icheck ><span style="padding:5px">হ্যাঁ</span></label> 
                </span>
                <br>
                <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                     <label class="inline-label"><input type="radio" value="No" id="val_radio_male" data-md-icheck name="hlt_chk_exe_premier"> <span style="padding:5px">না</span></label> 
                 </span>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                <label for="emergency_number" class=""> ওরাল ও ডেন্টাল হেলথ্ স্ক্রীনিং-প্রাপ্তবয়স্ক   </label> 
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                <label for="emergency_number" class=""> হোল বডি চেক আপ-পুরুষ ৪৫ বছরের নীচে  </label> 
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
   ...
   <div class="uk-grid" data-uk-grid-margin>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="parsley-row">
                <label for="message">কার্য দিবস</label>
...
@else  
    ...
    <p style="font-size: 16px;font-weight: bold; margin-bottom: 25px;"> Air Ambulance Facilities </p>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                <label for="emergency_number" class=""> Executive Basic Check Up-Male/Female  </label> 
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                   <label class="inline-label"><input type="radio" value="Yes" name="hlt_chk_exe_basic"id="val_radio_male" data-md-icheck ><span style="padding:5px">YES</span></label> 
                </span>
                <br>
                <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                     <label class="inline-label"><input type="radio" value="No" id="val_radio_male" data-md-icheck name="hlt_chk_exe_basic"> <span style="padding:5px">NO</span></label> 
                 </span>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                <label for="emergency_number" class=""> Executive Premier Check Up-Male/Female  </label> 
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                   <label class="inline-label"><input type="radio" value="Yes" name="hlt_chk_exe_premier"id="val_radio_male" data-md-icheck ><span style="padding:5px">YES</span></label> 
                </span>
                <br>
                <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                     <label class="inline-label"><input type="radio" value="No" id="val_radio_male" data-md-icheck name="hlt_chk_exe_premier"> <span style="padding:5px">NO</span></label> 
                 </span>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                ...
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                   <label class="inline-label"><input type="radio" value="Yes" name="hm_serv_serv_hour"id="val_radio_male" data-md-icheck ><span style="padding:5px">YES</span></label> 
                </span>
                <br>
                <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                     <label class="inline-label"><input type="radio" value="No" id="val_radio_male" data-md-icheck name="hm_serv_serv_hour"> <span style="padding:5px">NO</span></label> 
                 </span>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                ...
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                   <label class="inline-label"><input type="radio" value="Yes" name="hm_serv_working_day"id="val_radio_male" data-md-icheck ><span style="padding:5px">YES</span></label> 
                </span>
                <br>
                <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                     <label class="inline-label"><input type="radio" value="No" id="val_radio_male" data-md-icheck name="hm_serv_working_day"> <span style="padding:5px">NO</span></label> 
                 </span>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                ...
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                   <label class="inline-label"><input type="radio" value="Yes" name="ops_serv_hour"id="val_radio_male" data-md-icheck ><span style="padding:5px">YES</span></label> 
                </span>
                <br>
                <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                     <label class="inline-label"><input type="radio" value="No" id="val_radio_male" data-md-icheck name="ops_serv_hour"> <span style="padding:5px">NO</span></label> 
                 </span>
            </div>
        </div>
    </div>
    ...
    <div class="uk-grid" data-uk-grid-margin>
        <div class="uk-width-medium-1-1">
            <div class="uk-form-row parsley-row">
                ...
                <br>
                 <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                   <label class="inline-label"><input type="radio" value="Yes" name="ops_working_day"id="val_radio_male" data-md-icheck ><span style="padding:5px">YES</span></label> 
                </span>
                <br>
                <span style="padding:5px 5px 5px 0px" class="icheck-inline">
                     <label class="inline-label"><input type="radio" value="No" id="val_radio_male" data-md-icheck name="ops_working_day"> <span style="padding:5px">NO</span></label> 
                 </span>
            </div>
        </div>
    </div>
