...
@section('angular')
    ...
    <script src="{{url('app/admin/pharmacynew/pharmacynew.doctor_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="PharmacynewDoctorController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('pharmacynew/edit/doctor/add', $pharmacynew_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
