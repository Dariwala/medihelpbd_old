        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                   {!! Form::open(['url' => 'pharmacynew/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="pharmacynew_name">Name <span class="req">*</span></label>
                                    <input type="text" id="pharmacynew_name" name="pharmacynew_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_pharmacynew_name">নাম <span class="req">*</span></label>
                                    <input type="text" id="b_pharmacynew_name" name="b_pharmacynew_name" required class="md-input" /> 
                                </div>
                            </div>
...
<script>
    $('#district_id').on('change',function(){
        ...
        var address = "/pharmacynew/add/"+district_id;
