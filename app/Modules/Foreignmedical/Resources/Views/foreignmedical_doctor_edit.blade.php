...
@section('angular')
    ...
    <script src="{{url('app/admin/foreignmedical/foreignmedical.doctor_edit_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="ForeignmedicalDoctorEditController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('foreignmedical/edit/doctor/edit', $foreignmedical_doctor_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>

                        	<input type="hidden" ng-init="foreignmedical_doctor_id='asdfg'" value="{{$foreignmedical_doctor_id}}" name="foreignmedical_doctor_id" ng-model="foreignmedical_doctor_id">
