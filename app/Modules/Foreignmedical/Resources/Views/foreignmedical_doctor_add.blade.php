...
@section('angular')
    ...
    <script src="{{url('app/admin/foreignmedical/foreignmedical.doctor_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="ForeignmedicalDoctorController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('foreignmedical/edit/doctor/add', $foreignmedical_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
