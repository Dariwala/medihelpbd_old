            ...
            <div class="md-card-content">
                <div class="uk-overflow-container uk-margin-bottom">
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="dt_tableExport">
                        ...
                        <?php $i=1;?>
                        <tbody>
                        @foreach($pharmacies as $optical)
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td>{{ $optical['optical_name'] }}</td>
                                <td>{{ $optical['district_name'] }}</td>
                                <td>{{ $optical['sub_district_name'] }}</td>
                ...
                <div class="md-fab-wrapper Publication-create">
                    <a id="add_Publication_name_button" href="{{ url('optical/add') }}"  class="md-fab md-fab-accent Publication-create">
...
@section('script')
    ...
    $('.confirm').click(function(){
        ...
        swal({
            ...
            window.location.href = "/optical/delete/"+id;
        })
    });
</script>
