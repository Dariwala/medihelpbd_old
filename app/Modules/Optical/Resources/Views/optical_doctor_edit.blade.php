...
@section('angular')
    ...
    <script src="{{url('app/admin/optical/optical.doctor_edit_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="OpticalDoctorEditController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('optical/edit/doctor/edit', $optical_doctor_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>

                        	<input type="hidden" ng-init="optical_doctor_id='asdfg'" value="{{$optical_doctor_id}}" name="optical_doctor_id" ng-model="optical_doctor_id">
