        ...
        <div class="md-card">
            <div class="md-card-content">
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="dt_tableExport">
                        ...
                        @foreach($blood_banks as $blood_bank)
                            <tr>
                                ...
                                <td>{{ $blood_bank['district_name'] }}</td>
                                <td>{{ $blood_bank['sub_district_name'] }}</td>
                                <td>{{ $blood_bank['created_at'] }}</td>
                                <td>{{ $blood_bank['updated_at'] }}</td>
                                <td class="uk-text-center">
                                    <a href="{{ url('blood-bank/view'.'/'.$blood_bank['id'] )}}" class="publication-edit" ><i class="md-icon material-icons uk-margin-right">&#xE8F4;</i></a>
                                    <a href="{{ url('blood-bank/edit/info'.'/'.$blood_bank['id'] )}}" class="publication-edit" ><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                    <a class="confirm">
                                        <input class="confirm_id" type="hidden" name="id" value="{{$blood_bank['id'] }}">
                ...
                <div class="md-fab-wrapper Publication-create">
                    <a id="add_Publication_name_button" href="{{ url('blood-bank/add') }}"  class="md-fab md-fab-accent Publication-create">
...
@section('script')
    ...
    $('.confirm').click(function(){
        ...
        swal({
            ...
            window.location.href = "/blood-bank/delete/"+id;
        })
    });
</script>
