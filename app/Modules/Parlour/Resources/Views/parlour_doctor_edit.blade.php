...
@section('angular')
    ...
    <script src="{{url('app/admin/parlour/parlour.doctor_edit_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="ParlourDoctorEditController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('parlour/edit/doctor/edit', $parlour_doctor_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>

                        	<input type="hidden" ng-init="parlour_doctor_id='asdfg'" value="{{$parlour_doctor_id}}" name="parlour_doctor_id" ng-model="parlour_doctor_id">
