                                        ...
                                        <div class="uk-grid " data-uk-grid-margin>
                                            ...
                                            <div class="uk-width-medium-1-2">
                                                <div class="uk-grid uk-grid-medium form_section form_section_separator" data-uk-grid-match>
                                                    <div class="uk-width-8-10">
                                                        <div class="parsley-row uk-margin-top">
                                                            <label for="parlour_phone_no">Phone<span class="req">*</span></label>
                                            ...
                                            <div class="uk-width-medium-1-2">
                                                <div class="uk-grid uk-grid-medium form_section form_section_separator" data-uk-grid-match>
                                                    <div class="uk-width-8-10">
                                                        <div class="parsley-row uk-margin-top">
                                                            <label for="b_parlour_phone_no">ফোন <span class="req">*</span></label>
                                            ...
                                            <div class="uk-width-medium-1-2">
                                                <div class="uk-grid uk-grid-medium form_section form_section_separator" data-uk-grid-match>
                                                    <div class="uk-width-8-10">
                                                        <div class="parsley-row uk-margin-top">
                                                            <label for="parlour_email_ad">Email<span class="req">*</span></label>
