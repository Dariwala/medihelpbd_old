        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => 'parlour/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="parlour_name">Name<span class="req">*</span></label>
                                    <input type="text" id="parlour_name" name="parlour_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_parlour_name">নাম<span class="req">*</span></label>
                                    <input type="text" id="b_parlour_name" name="b_parlour_name" required class="md-input" /> 
                                </div>
                            </div>
