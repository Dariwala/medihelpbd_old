        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => 'herbal-center/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="herbal_center_name">Name<span class="req">*</span></label>
                                    <input type="text" id="herbal_center_name" name="herbal_center_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_herbal_center_name">নাম<span class="req">*</span></label>
                                    <input type="text" id="b_herbal_center_name" name="b_herbal_center_name" required class="md-input" /> 
                                </div>
                            </div>
...
<script>
    $('#district_id').on('change',function(){
        ...
        var address = "/herbal-center/add/"+district_id;
