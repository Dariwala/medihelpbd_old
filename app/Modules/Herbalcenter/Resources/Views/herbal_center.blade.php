            ...
            <div class="md-card-content">
                <div class="uk-overflow-container uk-margin-bottom">
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="dt_tableExport">
                        ...
                        <?php $i=1;?>
                        <tbody>
                        @foreach($herbal_centers as $herbal_center)
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td>{{ $herbal_center['herbal_center_name'] }}</td>
                                <td>{{ $herbal_center['district_name'] }}</td>
                                <td>{{ $herbal_center['sub_district_name'] }}</td>
                ...
                <div class="md-fab-wrapper Publication-create">
                    <a id="add_Publication_name_button" href="{{ url('herbal-center/add')}}"  class="md-fab md-fab-accent Publication-create">
...
@section('script')
    ...
    $('.confirm').click(function(){
        ...
        swal({
            ...
            window.location.href = "/herbal-center/delete/"+id;
        })
    });
</script>
