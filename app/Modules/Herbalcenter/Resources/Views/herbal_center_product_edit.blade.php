...
@section('angular')
    ...
    <script src="{{url('app/admin/herbal_center/herbal_center.product_category_edit_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="HerbalCenterProductEditController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                {!! Form::open(['url' => array('herbal-center/edit/product/edit', $product_id,$herbal_center_id), 'method' => 'post', 'class' => 'uk-form-stacked','files' => true]) !!}
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-1">

                        <input type="hidden" ng-init="herbal_center_product_id='asdfg'" value="{{$product_id}}" name="herbal_center_product_id" ng-model="herbal_center_product_id">
