...
@section('angular')
    <script src="{{url('app/frontend/frontend/vaccine_point.view.js')}}"></script>
    <script src="{{url('app/frontend/frontend/vaccine_point.b_view.js')}}"></script>
@endsection
            ...
            <div class="menu_section">
                <ul>
                    @foreach($aside_results as $aside_result)
                        @if($vaccine_point->id == $aside_result->id)
                            <li class="selectedSidebar">
                                <a href="{{ url('frontendvaccinepoint/view'.'/'.$aside_result->id.'/'.$aside_result->subdistrict_id)}}">
                                    <span class="md-list-heading">{{$aside_result->b_vaccine_point_name}}</span>
                                </a>
                            </li>
                        @else
                            <li title="">
                ...
                <ul>
                    @foreach($aside_results as $aside_result)
                        @if($vaccine_point->id == $aside_result->id)
                            <li class="selectedSidebar">
                                <a href="{{ url('frontendvaccinepoint/view'.'/'.$aside_result->id.'/'.$aside_result->subdistrict_id)}}">
                                    <span class="md-list-heading">{{$aside_result->vaccine_point_name}}</span>
                                </a>
                            </li>
                        @else
                            <li title="">
                ...
                <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                    <li><?php echo $vaccine_point->b_vaccine_point_description; ?>
                                ...
                                <ul class="md-list md-list-addon">
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            <span style="margin-top:5px" class="md-list-heading">{!! nl2br ($vaccine_point->b_vaccine_point_address) !!}</span> <span class="uk-text-small uk-text-muted hidden">Address</span>
                                        </div>
                                    </li>
                        ...
                        <div class="uk-width-large-1-1 google_maps_show">
                             <iframe 
                                src="https://www.google.com/maps/embed/v1/search?key=AIzaSyD3_tCn50Ef5Z2zUJxkXi26T486gIzIHp8&q={{ $vaccine_point->vaccine_point_latitude }}, {{ $vaccine_point->vaccine_point_longitude }}&zoom=15" frameborder="0" height="600" style="border:0; width:100%;" allowfullscreen>
                            </iframe>
                        </div>
                        ...
                        <ul class="md-list">
                            <li ng-repeat = "service in services">
                                <div style="margin-top: -10px;" class="md-list-content">
                                    <div>
                                        <span class="uk-margin-right" ng-bind-html="trustAsHtml(service.b_vaccine_point_service_description)">
                                        </span>
                                    </div>
                                </div>
                            </li>
