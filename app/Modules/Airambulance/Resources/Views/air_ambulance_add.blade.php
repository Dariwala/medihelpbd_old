        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => 'air-ambulance/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="air_ambulance_name">Name<span class="req">*</span></label>
                                    <input type="text" id="air_ambulance_name" name="air_ambulance_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_air_ambulance_name">নাম<span class="req">*</span></label>
                                    <input type="text" id="b_air_ambulance_name" name="b_air_ambulance_name" required class="md-input" /> 
                                </div>
                            </div>
...
<script>
    $('#district_id').on('change',function(){
        ...
        var address = "/air-ambulance/add/"+district_id;
