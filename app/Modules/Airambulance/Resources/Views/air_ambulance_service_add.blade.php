        ...
        <div class="md-card"  ng-controller="BloodBankServiceController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('air-ambulance/edit/service/add', $air_ambulance_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                                    ...
                                    <div class="uk-width-9-12">
                                        ...
                                        <div class="uk-grid">
                                            <div class="uk-width-1-2">
                                                ...
                                                <div class="parsley-row">
                                                    <textarea class="md-input" id="air_ambulance_service_description" name="air_ambulance_service_description" cols="10" rows="3" data-parsley-trigger="keyup" ></textarea>
                                                </div>
                                            ...
                                            <div class="uk-width-1-2">
                                                <label>বর্ণনা</label>
                                                <div class="parsley-row">
                                                    <textarea class="md-input" id="b_air_ambulance_service_description" name="b_air_ambulance_service_description" cols="10" rows="3" data-parsley-trigger="keyup" ></textarea>
                                                </div>
