        ...
        <div class="md-card">
            <div class="md-card-content">
                    ...
                    <table class="uk-table" id="dt_tableExport">
                        ...
                        @foreach($yogas as $yoga)
                            <tr>
                                ...
                                <td>{{ $yoga['district_name'] }}</td>
                                <td>{{ $yoga['sub_district_name'] }}</td>
                ...
                <div class="md-fab-wrapper Publication-create">
                    <a id="add_Publication_name_button" href="{{ url('yoga/add')}}"  class="md-fab md-fab-accent Publication-create">
...
@section('script')
    ...
    $('.confirm').click(function(){
        ...
        swal({
            ...
            window.location.href = "/yoga/delete/"+id;
        })
    });
</script>
