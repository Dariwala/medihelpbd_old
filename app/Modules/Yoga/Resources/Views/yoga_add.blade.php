        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => 'yoga/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="yoga_name">Name<span class="req">*</span></label>
                                    <input type="text" id="yoga_name" name="yoga_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_yoga_name">নাম<span class="req">*</span></label>
                                    <input type="text" id="b_yoga_name" name="b_yoga_name" required class="md-input" /> 
                                </div>
                            </div>
