...
@section('angular')
    ...
    <script src="{{url('app/admin/vaccine_point/vaccine_point.doctor_edit_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="VaccinePointDoctorEditController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('vaccine-point/edit/doctor/edit', $vaccine_point_doctor_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>

                        	<input type="hidden" ng-init="vaccine_point_doctor_id='asdfg'" value="{{$vaccine_point_doctor_id}}" name="vaccine_point_doctor_id" ng-model="vaccine_point_doctor_id">
