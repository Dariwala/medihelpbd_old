        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => 'vaccine-point/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="vaccine_point_name">Name<span class="req">*</span></label>
                                    <input type="text" id="vaccine_point_name" name="vaccine_point_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_vaccine_point_name">নাম<span class="req">*</span></label>
                                    <input type="text" id="b_vaccine_point_name" name="b_vaccine_point_name" required class="md-input" /> 
                                </div>
                            </div>
...
<script>
    $('#district_id').on('change',function(){
        ...
        var address = "/vaccine-point/add/"+district_id;
