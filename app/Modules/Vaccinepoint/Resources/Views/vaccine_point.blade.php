            ...
            <div class="md-card-content">
                <div class="uk-overflow-container uk-margin-bottom">
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="dt_tableExport">
                        ...
                        <?php $i=1;?>
                        <tbody>
                        @foreach($vaccine_points as $vaccine_point)
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td>{{ $vaccine_point['vaccine_point_name'] }}</td>
                                <td>{{ $vaccine_point['district_name'] }}</td>
                                <td>{{ $vaccine_point['sub_district_name'] }}</td>
                ...
                <div class="md-fab-wrapper Publication-create">
                    <a id="add_Publication_name_button" href="{{ url('vaccine-point/add')}}"  class="md-fab md-fab-accent Publication-create">
...
@section('script')
    ...
    $('.confirm').click(function(){
        ...
        swal({
            ...
            window.location.href = "/vaccine-point/delete/"+id;
        })
    });
</script>
