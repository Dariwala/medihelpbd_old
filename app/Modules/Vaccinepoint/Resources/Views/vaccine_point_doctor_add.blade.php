...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="VaccinePointDoctorController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('vaccine-point/edit/doctor/add', $vaccine_point_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
