        ...
        <div class="md-card">
            <div class="md-card-content">
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="dt_tableExport">
                        ...
                        @foreach($ambulances as $ambulance)
                            <tr>
                                ...
                                <td>{{ $ambulance['district_name'] }}</td>
                                <td>{{ $ambulance['sub_district_name'] }}</td>
                                <td>{{ $ambulance['created_at'] }}</td>
                                <td>{{ $ambulance['updated_at'] }}</td>
                                <td class="uk-text-center">
                                    <a href="{{ url('ambulance/view'.'/'.$ambulance['id'] )}}" class="publication-edit" ><i class="md-icon material-icons uk-margin-right">&#xE8F4;</i></a>
                                    <a href="{{ url('ambulance/edit/info'.'/'.$ambulance['id'] )}}" class="publication-edit" ><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                    <a class="confirm">
                                        <input class="confirm_id" type="hidden" name="id" value="{{$ambulance['id'] }}">
                ...
                <div class="md-fab-wrapper Publication-create">
                    <a id="add_Publication_name_button" href="{{ url('ambulance/add') }}"  class="md-fab md-fab-accent Publication-create">
...
@section('script')
    ...
    $('.confirm').click(function(){
        ...
        swal({
            ...
            window.location.href = "/ambulance/delete/"+id;
        })
    });
</script>
