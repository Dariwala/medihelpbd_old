        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('addiction/edit/notice/add', $addiction_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                                        ...
                                        <div class="uk-grid">
                                            <div class="uk-width-1-2 uk-margin-top">
                                                ...
                                                <div class="parsley-row">
                                                    <textarea class="md-input" id="addiction_notice_description" name="addiction_notice_description" cols="10" rows="2" data-parsley-trigger="keyup" ></textarea>
                                                </div>
                                            </div>
                                            <div class="uk-width-1-2 uk-margin-top">
                                                <label>বর্ণনা</label>
                                                <div class="parsley-row">
                                                    <textarea class="md-input" id="b_addiction_notice_description" name="b_addiction_notice_description" cols="10" rows="2" data-parsley-trigger="keyup" ></textarea>
                                                </div>
                                            </div>
                                        </div>
