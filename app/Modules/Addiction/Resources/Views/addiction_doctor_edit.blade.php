...
@section('angular')
    ...
    <script src="{{url('app/admin/addiction/addiction.doctor_edit_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="AddictionDoctorEditController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('addiction/edit/doctor/edit', $addiction_doctor_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>

                        	<input type="hidden" ng-init="addiction_doctor_id='asdfg'" value="{{$addiction_doctor_id}}" name="addiction_doctor_id" ng-model="addiction_doctor_id">
