        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => 'addiction/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="addiction_name">Name <span class="req">*</span></label>
                                    <input type="text" id="addiction_name" name="addiction_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_addiction_name">নাম<span class="req">*</span></label>
                                    <input type="text" id="b_addiction_name" name="b_addiction_name" required class="md-input" /> 
                                </div>
                            </div>
