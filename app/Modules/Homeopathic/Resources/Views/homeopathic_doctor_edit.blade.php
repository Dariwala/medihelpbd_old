...
@section('angular')
    ...
    <script src="{{url('app/admin/homeopathic/homeopathic.doctor_edit_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="HomeopathicDoctorEditController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('homeopathic/edit/doctor/edit', $homeopathic_doctor_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>

                        	<input type="hidden" ng-init="homeopathic_doctor_id='asdfg'" value="{{$homeopathic_doctor_id}}" name="homeopathic_doctor_id" ng-model="homeopathic_doctor_id">
