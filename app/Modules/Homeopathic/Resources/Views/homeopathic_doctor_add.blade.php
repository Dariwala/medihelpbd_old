...
@section('angular')
    ...
    <script src="{{url('app/admin/homeopathic/homeopathic.doctor_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="HomeopathicDoctorController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('homeopathic/edit/doctor/add', $homeopathic_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
