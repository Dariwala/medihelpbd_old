        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                   {!! Form::open(['url' => 'homeopathic/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="homeopathic_name">Name<span class="req">*</span></label>
                                    <input type="text" id="homeopathic_name" name="homeopathic_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_homeopathic_name">নাম<span class="req">*</span></label>
                                    <input type="text" id="b_homeopathic_name" name="b_homeopathic_name" required class="md-input" /> 
                                </div>
                            </div>
...
<script>
    $('#district_id').on('change',function(){
        ...
        var address = "/homeopathic/add/"+district_id;
