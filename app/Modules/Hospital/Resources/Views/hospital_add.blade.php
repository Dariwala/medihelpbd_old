        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => 'hospital/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="hospital_name">Name<span class="req">*</span></label>
                                    <input type="text" id="hospital_name" name="hospital_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_hospital_name">নাম<span class="req">*</span></label>
                                    <input type="text" id="b_hospital_name" name="b_hospital_name" required class="md-input" /> 
                                </div>
                            </div>
