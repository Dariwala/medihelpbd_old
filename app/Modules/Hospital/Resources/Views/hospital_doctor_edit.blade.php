...
@section('angular')
    ...
    <script src="{{url('app/admin/hospital/hospital.doctor_edit_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="HospitalDoctorEditController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('hospital/edit/doctor/edit', $hospital_doctor_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>

                        	<input type="hidden" ng-init="hospital_doctor_id='asdfg'" value="{{$hospital_doctor_id}}" name="hospital_doctor_id" ng-model="hospital_doctor_id">
