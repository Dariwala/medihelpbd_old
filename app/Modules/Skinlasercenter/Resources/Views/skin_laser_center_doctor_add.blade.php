...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="SkinLaserCenterDoctorController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('skin-laser-center/edit/doctor/add', $skin_laser_center_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
