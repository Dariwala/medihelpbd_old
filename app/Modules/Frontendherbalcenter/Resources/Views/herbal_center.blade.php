...
@section('angular')
    <script src="{{url('app/frontend/frontend/herbal_center.view.js')}}"></script>
    <script src="{{url('app/frontend/frontend/herbal_center.b_view.js')}}"></script>
@endsection
            ...
            <div class="menu_section">
                <ul>
                    @foreach($aside_results as $aside_result)
                        @if($herbal_center->id == $aside_result->id)
                            <li class="selectedSidebar">
                                <a href="{{ url('frontendherbalcenter/view'.'/'.$aside_result->id.'/'.$aside_result->subdistrict_id)}}">
                                    <span class="md-list-heading">{{$aside_result->b_herbal_center_name}}</span>
                                </a>
                            </li>
                        @else
                            <li title="">
                ...
                <ul>
                    @foreach($aside_results as $aside_result)
                        @if($herbal_center->id == $aside_result->id)
                            <li class="selectedSidebar">
                                <a href="{{ url('frontendherbalcenter/view'.'/'.$aside_result->id.'/'.$aside_result->subdistrict_id)}}">
                                    <span class="md-list-heading">{{$aside_result->herbal_center_name}}</span>
                                </a>
                            </li>
                        @else
                            <li title="">
        ...
        <div class="md-card">
            <div class="user_heading">
                ...
                <div class="user_heading_content">
                    <h2 style="margin: 10px;" class="heading_b uk-margin-bottom"><span class="uk-text-truncate">{{$herbal_center->b_herbal_center_name}}</span>
                    </h2>
                </div>
            </div>
            ...
            <div class="user_content">
                ...
                <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                    <li><?php echo $herbal_center->b_herbal_center_description; ?>
                                ...
                                <ul class="md-list md-list-addon">
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            <span style="margin-top:5px" class="md-list-heading">{!! nl2br($herbal_center->b_herbal_center_address) !!}</span> <span class="uk-text-small uk-text-muted hidden">Address</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="md-list-addon-element">
                                        ...
                                        <div class="md-list-content">
                                            <span style="margin-top:5px" class="md-list-heading">{!! nl2br($herbal_center->b_herbal_center_phone_no) !!}</span>
                                    ...
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            <span style="margin-top:5px" class="md-list-heading">{{$herbal_center->herbal_center_email_ad}}</span>
                                    ...
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            <span style="margin-top:5px" class="md-list-heading">{{$herbal_center->herbal_center_web_link}}</span> <span class="uk-text-small uk-text-muted hidden">Website</span>
                                        </div>
                                    </li>
                                    <li class="hidden">
                                        <div class="md-list-addon-element">
                        ...
                        <div class="uk-width-large-1-1">
                            ...
                            <ul class="md-list uk-margin-small-top">
                                <li>
                                    <div class="md-list-content">
                                        <span><?php echo $herbal_center->b_herbal_center_total_bed; ?></span>
                                    </div>
                                </li>
                            </ul>  
                        </div>           
                        ...
                        @if( $herbal_center->herbal_center_latitude != null && $herbal_center->herbal_center_longitude != null )
                        
                        <div class="uk-width-large-1-1 google_maps_show">
                             <iframe 
                                src="https://www.google.com/maps/embed/v1/search?key=AIzaSyD3_tCn50Ef5Z2zUJxkXi26T486gIzIHp8&q={{ $herbal_center->herbal_center_latitude }}, {{ $herbal_center->herbal_center_longitude }}&zoom=15" frameborder="0" height="600" style="border:0; width:100%;" allowfullscreen>
                            </iframe>
                        </div>
                        ...
                        <ul class="md-list">
                            <li style="padding-top: 0px;">
                                <div class="md-list-content">
                                    ...
                                    <span class="uk-margin-right"><?php echo $notice->b_herbal_center_notice_description; ?></span>
                                    @endforeach
                                </div>
                            </li>
                        </ul>
                    ...
                    <li>
                        <ul class="md-list">
                            ...
                            <li style="padding-top: 0px;">
                                <div class="md-list-content">
                                        <span class="uk-margin-right"><?php echo $product->b_herbal_center_product_description; ?></span>
                                </div>
                            </li>
                            @endforeach
                        </ul>
                        ...
                        <ul class="md-list">
                            <li ng-repeat = "service in services">
                                <div style="margin-top: -10px;" class="md-list-content">
                                    <div>
                                        <span class="uk-margin-right" ng-bind-html="trustAsHtml(service.b_herbal_center_service_description)">
                                        </span>
                                    </div>
                                </div>
                            </li>
    ...
    @else
        ...
        <div class="md-card">
            <div class="user_heading">
                ...
                <div class="user_heading_content">
                    <h2 style="margin: 10px;" class="heading_b uk-margin-bottom"><span class="uk-text-truncate">{{$herbal_center->herbal_center_name}}</span>
                    </h2>
                </div>
            </div>
            ...
            <div class="user_content">
                ...
                <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                    <li><?php echo $herbal_center->herbal_center_description; ?>
                            ...
                            <div class="uk-width-large-1-1">
                                ...
                                <ul class="md-list md-list-addon">
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            <span style="margin-top:5px" class="md-list-heading">{!! nl2br($herbal_center->herbal_center_address) !!}</span> <span class="uk-text-small uk-text-muted hidden">Address</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="md-list-addon-element">
                                        ...
                                        <div class="md-list-content">
                                            <span style="margin-top:5px" class="md-list-heading">{!! nl2br($herbal_center->herbal_center_phone_no) !!}</span>
                                             <span class="uk-text-small uk-text-muted hidden">Phone</span>
                                        </div>
                                    </li>
                                    <li>
                        ...
                        <div class="uk-width-large-1-1">
                            ...
                            <ul class="md-list uk-margin-small-top">
                                <li>
                                    <div class="md-list-content">
                                        <span><?php echo $herbal_center->herbal_center_total_bed; ?></span>
                                    </div>
                                </li>
                            </ul>  
                        </div>
                    ...
                    <li>
                        <ul class="md-list">
                            <li style="padding-top: 0px;">
                                <div class="md-list-content">
                                    @foreach($notices as $notice)
                                    <span class="uk-margin-right"><?php echo $notice->herbal_center_notice_description; ?></span>
                                    @endforeach
                                </div>
                            </li>
                        </ul>
                    ...
                    <li>
                        <ul class="md-list">
                            ...
                            <li style="padding-top: 0px;">
                                <div class="md-list-content">
                                        <span class="uk-margin-right"><?php echo $product->herbal_center_product_description; ?></span>
                                </div>
                            </li>
                            @endforeach
                        </ul>
                    ...
                    <li ng-controller="ViewHerbalCenterController">
                        ...
                        <ul class="md-list">
                            <li ng-repeat = "service in services">
                                <div style="margin-top: -10px;" class="md-list-content">
                                    <div>
                                        <span class="uk-margin-right" ng-bind-html="trustAsHtml(service.herbal_center_service_description)">
                                        </span>
                                    </div>
                                </div>
                            </li>
