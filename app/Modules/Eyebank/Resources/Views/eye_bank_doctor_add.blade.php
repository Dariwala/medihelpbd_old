...
@section('angular')
    ...
    <script src="{{url('app/admin/eye_bank/eye_bank.doctor_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="EyeBankDoctorController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('eye-bank/edit/doctor/add', $eye_bank_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
