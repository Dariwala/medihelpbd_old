        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => 'eye-bank/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="eye_bank_name">Name<span class="req">*</span></label>
                                    <input type="text" id="eye_bank_name" name="eye_bank_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_eye_bank_name">নাম<span class="req">*</span></label>
                                    <input type="text" id="b_eye_bank_name" name="b_eye_bank_name" required class="md-input" /> 
                                </div>
                            </div>
...
<script>
    $('#district_id').on('change',function(){
        ...
        var address = "/eye-bank/add/"+district_id;
