            ...
            <div class="md-card-content">
                <div class="uk-overflow-container uk-margin-bottom">
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="dt_tableExport">
                        ...
                        <?php $i=1;?>
                        <tbody>
                        @foreach($eye_banks as $eye_bank)
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td>{{ $eye_bank['eye_bank_name'] }}</td>
                                <td>{{ $eye_bank['district_name'] }}</td>
                                <td>{{ $eye_bank['sub_district_name'] }}</td>
                ...
                <div class="md-fab-wrapper Publication-create">
                    <a id="add_Publication_name_button" href="{{ url('eye-bank/add') }}"  class="md-fab md-fab-accent Publication-create">
...
@section('script')
    ...
    $('.confirm').click(function(){
        ...
        swal({
            ...
            window.location.href = "/eye-bank/delete/"+id;
        })
    });
</script>
