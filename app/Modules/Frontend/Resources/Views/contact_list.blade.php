                            ...
                            <a href="{{ url('frontendaddiction/view'.'/'.$contact->id.'/'.$contact->subdistrict_id)}}">
                                <div class="md-card md-card-hover">
                                    <div class="md-card-head">
                                        @if($contact->photo_path == '')
                                        <div class="uk-text-center">
                                            <img class="md-card-head-avatar" style = "border: 1px solid red;" src="{{url('addiction.jpg')}}" alt=""/>
                                        </div> 
                                        @else
                                       <div class="uk-text-center">
                                            <img class="md-card-head-avatar" style = "border: 1px solid red;" src="{{ url($contact->photo_path) }}" alt=""/>
                            ...
                            <a href="{{ url('frontendforeignmedical/view'.'/'.$contact->id.'/'.$contact->subdistrict_id)}}">
                                <div class="md-card md-card-hover">
                                    <div class="md-card-head">
                                        @if($contact->photo_path == '')
                                        <div class="uk-text-center">
                                            <img class="md-card-head-avatar" style = "border: 1px solid red;" src="{{url('foreignmedical.jpg')}}" alt=""/>
                                        </div> 
                                        @else
                                       <div class="uk-text-center">
                                            <img class="md-card-head-avatar" style = "border: 1px solid red;" src="{{ url($contact->photo_path) }}" alt=""/>
                            ...
                            <a href="{{ url('frontendgym/view'.'/'.$contact->id.'/'.$contact->subdistrict_id)}}">
                                <div class="md-card md-card-hover">
                                    <div class="md-card-head">
                                        @if($contact->photo_path == '')
                                        <div class="uk-text-center">
                                            <img class="md-card-head-avatar" style = "border: 1px solid red;" src="{{url('gym.jpg')}}" alt=""/>
                                        </div> 
                                        @else
                                       <div class="uk-text-center">
                                            <img class="md-card-head-avatar" style = "border: 1px solid red;" src="{{ url($contact->photo_path) }}" alt=""/>
                            ...
                            <a href="{{ url('frontendpharmacynew/view'.'/'.$contact->id.'/'.$contact->subdistrict_id)}}">
                                <div class="md-card md-card-hover">
                                    <div class="md-card-head">
                                        @if($contact->photo_path == '')
                                        <div class="uk-text-center">
                                            <img class="md-card-head-avatar" style = "border: 1px solid red;" src="{{url('pharmacynew.jpg')}}" alt=""/>
                                        </div> 
                                        @else
                                       <div class="uk-text-center">
                                            <img class="md-card-head-avatar" style = "border: 1px solid red;" src="{{ url($contact->photo_path) }}" alt=""/>
                            ...
                            <a href="{{ url('frontendyoga/view'.'/'.$contact->id.'/'.$contact->subdistrict_id)}}">
                                <div class="md-card md-card-hover">
                                    <div class="md-card-head">
                                        @if($contact->photo_path == '')
                                        <div class="uk-text-center">
                                            <img class="md-card-head-avatar" style = "border: 1px solid red;" src="{{url('yoga.jpg')}}" alt=""/>
                                        </div> 
                                        @else
                                       <div class="uk-text-center">
                                            <img class="md-card-head-avatar" style = "border: 1px solid red;" src="{{ url($contact->photo_path) }}" alt=""/>
