            ...
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content">
                        <h2 class="heading_b uk-margin-bottom"><span style= "margin: 10px" class="uk-text-truncate">{{$parlour->b_parlour_name}}</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="user_content">
                    ...
                    <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                        <li><?php echo $parlour->b_parlour_description; ?>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading">{!! nl2br ($parlour->b_parlour_phone_no) !!}</span>
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading ">{{$parlour->parlour_email_ad}}</span>
                            ...
                            @if( $parlour->parlour_latitude != null && $parlour->parlour_longitude != null )
                        ...
                        <li ng-controller="ViewBnParlourController">
                            ...
                            <div   class="uk-form-row">
                                <input id="service_id" name="service_id" ng-model="service_id" ng-change="getParlourService()"   style="width: 100%;" />
                            </div>
                            <ul class="md-list">
        ...
        <div class="uk-width-large-7-10">
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content">
                        <h2 class="heading_b uk-margin-bottom"><span style= "margin: 10px" class="uk-text-truncate">{{$parlour->parlour_name}}</span>
                        </h2>
                    </div>
                </div>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading">{!! nl2br ($parlour->parlour_phone_no) !!}</span>
