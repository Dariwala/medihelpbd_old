            ...
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content">
                        <h2 class="heading_b uk-margin-bottom"><span style="margin: 10px;" class="uk-text-truncate">{{$homeopathic->b_homeopathic_name}}</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="user_content">
                    ...
                    <ul class="uk-switcher uk-margin" id="user_profile_tabs_content">
                        <li><?php echo $homeopathic->b_homeopathic_description; ?>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px"  class="md-list-heading">{!! nl2br ($homeopathic->b_homeopathic_phone_no) !!}</span>
                            ...
                            @if( $homeopathic->homeopathic_latitude != null && $homeopathic->homeopathic_longitude != null )
