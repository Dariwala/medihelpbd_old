        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                   {!! Form::open(['url' => 'pharmacy/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="pharmacy_name">Name <span class="req">*</span></label>
                                    <input type="text" id="pharmacy_name" name="pharmacy_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_pharmacy_name">নাম <span class="req">*</span></label>
                                    <input type="text" id="b_pharmacy_name" name="b_pharmacy_name" required class="md-input" /> 
                                </div>
                            </div>
...
<script>
    $('#district_id').on('change',function(){
        ...
        var address = "/pharmacy/add/"+district_id;
