...
@section('angular')
    ...
    <script src="{{url('app/admin/pharmacy/pharmacy.doctor_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="PharmacyDoctorController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('pharmacy/edit/doctor/add', $pharmacy_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
