...
@section('angular')
    ...
    <script src="{{url('app/admin/pharmacy/pharmacy.doctor_edit_controller.js')}}"></script>
@endsection
...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <div class="md-card"  ng-controller="PharmacyDoctorEditController">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => array('pharmacy/edit/doctor/edit', $pharmacy_doctor_id), 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>

                        	<input type="hidden" ng-init="pharmacy_doctor_id='asdfg'" value="{{$pharmacy_doctor_id}}" name="pharmacy_doctor_id" ng-model="pharmacy_doctor_id">
