        ...
        <div class="md-card">
            <div class="md-card-content">
                <div class="uk-overflow-container">
                    {!! Form::open(['url' => 'blood-donar/add', 'method' => 'post', 'class' => 'uk-form-stacked']) !!}
                        <div class="uk-grid" data-uk-grid-margin>
                            ...
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="blood_donor_name">Name<span class="req">*</span></label>
                                    <input type="text" id="blood_donor_name" name="blood_donor_name" required class="md-input" /> 
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2 uk-margin-top">
                                <div class="parsley-row">
                                    <label for="b_blood_donor_name">নাম<span class="req">*</span></label>
                                    <input type="text" id="b_blood_donor_name" name="b_blood_donor_name" required class="md-input" /> 
                                </div>
                            </div>
                        </div>
...
<script>
    $('#district_id').on('change',function(){
        ...
        var address = "/blood-donar/add/"+district_id;
