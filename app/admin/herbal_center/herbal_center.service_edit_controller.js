// blank controller
herbal_center.controller('HerbalCenterServiceEditController', HerbalCenterServiceEditController);

function HerbalCenterServiceEditController($scope, $http) {


    var herbal_center_service_id = document.getElementsByName('herbal_center_service_id')[0].value;
    console.log(herbal_center_service_id);

    $http
        .get(window.location.origin+"/service/api/herbal-center/get-selected-service/" + herbal_center_service_id, {
        ...
        $http
        .get(window.location.origin+"/service/api/herbal-center/get-selected-subservice/" + herbal_center_service_id, {
            transformRequest: angular.identity,
            headers: {'Content-Type': undefined, 'Process-Data': false}
        })
        .then(function(response){
