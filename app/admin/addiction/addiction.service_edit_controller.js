// blank controller
addiction.controller('AddictionServiceEditController', AddictionServiceEditController);

function AddictionServiceEditController($scope, $http) {


    var addiction_service_id = document.getElementsByName('addiction_service_id')[0].value;
    console.log(addiction_service_id);

    $http
        .get(window.location.origin+"/service/api/addiction/get-selected-service/" + addiction_service_id, {
        ...
        $http
        .get(window.location.origin+"/service/api/addiction/get-selected-subservice/" + addiction_service_id, {
            transformRequest: angular.identity,
            headers: {'Content-Type': undefined, 'Process-Data': false}
        })
        .then(function(response){
