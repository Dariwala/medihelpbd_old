// blank controller
eye_bank.controller('EyeBankDoctorEditController', EyeBankDoctorEditController);

function EyeBankDoctorEditController($scope, $http) {

    var eye_bank_doctor_id = document.getElementsByName('eye_bank_doctor_id')[0].value;
